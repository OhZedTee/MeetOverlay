...
enum MeetOverlayTheme {
    enum Palette {
        ...
        static let iconBadgeBackground = Color(nsColor: .tertiarySystemFill)
        ...
        static let overlayPanelBorder = Color.white.opacity(0.16)
    ...
    enum Spacing {
        ...
        static let overlayPanelHorizontal: CGFloat = 64
        static let overlayPanelVertical: CGFloat = 54
    }
    ...
    enum Radius {
        ...
        static let card: CGFloat = 16
        static let overlayPanel: CGFloat = 34
    }

    enum Size {
        static let settingsIconBadge: CGFloat = 22
        static let overlayIconBadge: CGFloat = 68
    }
    ...
    enum Typography {
        ...
        static let overlayStatus = Font.system(size: 30, weight: .semibold)
        static let overlayTitle = Font.system(size: 56, weight: .bold)
        static let overlayMetadata = Font.system(size: 20, weight: .semibold)
        static let overlayButton = Font.system(size: 22, weight: .semibold)
        static let overlayHint = Font.system(size: 16, weight: .medium)
    }
}
